  ...
  return (
    <>
      ...
      <p>
        ...
        of Charter's Website, located at https://charter.bitmetro.io.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Charter if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Charter, you agreed to use
        cookies in agreement with the Charter's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Charter and/or its licensors own the
        intellectual property rights for all material on Charter. All
        intellectual property rights are reserved. You may access this from
        Charter for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Charter</li>
        <li>Sell, rent or sub-license material from Charter</li>
        <li>Reproduce, duplicate or copy material from Charter</li>
        <li>Redistribute content from Charter</li>
      </ul>
      ...
      <p>
        ...
        Charter does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Charter,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Charter shall not be liable for the
      ...
      <p>
        Charter reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Charter a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Charter; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Charter. Please include your name, your organization name,
      ...
      <p>
        No use of Charter's logo or other artwork will be allowed for linking
